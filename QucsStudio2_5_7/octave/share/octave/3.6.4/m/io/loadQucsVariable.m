...
% -*- texinfo -*-
% @deftypefn {Function File} {[@var{x}, @var{dep}] =} loadQucsVariable (@var{filename}, @var{varname})
% Read the vector @var{x} from a Qucs dataset file.
% The string @var{dep} contains the dependencies (variable names separated by a spaces).
%
% Example
% @example
